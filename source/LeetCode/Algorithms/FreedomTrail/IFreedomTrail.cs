...
{
    /// <summary>
    ///     Computes the minimum number of steps to spell out <paramref name="key" /> by rotating <paramref name="ring" /> so each required character aligns
    ///     with the pointer, then pressing the button to confirm it.
    /// </summary>
