...
{
    /// <summary>
    ///     Computes the "power" of every contiguous subarray of length <paramref name="k" /> in <paramref name="nums" />, where the power is the maximum element if the subarray forms a sequence of consecutive integers, or <c>-1</c> otherwise.
    /// </summary>
