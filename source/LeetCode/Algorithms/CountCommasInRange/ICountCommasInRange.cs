...
namespace LeetCode.Algorithms.CountCommasInRange;

/// <summary>
///     https://leetcode.com/problems/count-commas-in-range/description/
/// </summary>
public interface ICountCommasInRange
{
    /// <summary>
    ///     Counts commas used when formatting all integers from 1 through n.
    /// </summary>
    /// <param name="n">The inclusive upper bound, between 1 and 100,000.</param>
