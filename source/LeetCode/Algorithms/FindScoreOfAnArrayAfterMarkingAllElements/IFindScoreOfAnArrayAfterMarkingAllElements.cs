...
{
    /// <summary>
    ///     Repeatedly picks the smallest unmarked element (leftmost on ties) in <paramref name="nums" />, adds its value to the score, and marks it along
    ///     with its adjacent elements, until all elements are marked.
    /// </summary>
