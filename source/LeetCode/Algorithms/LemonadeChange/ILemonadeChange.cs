...
{
    /// <summary>
    ///     Determines whether every customer, paying in the order given by <paramref name="bills" />, can be given correct change for a $5 lemonade using only $5, $10, and $20 bills received so far.
    /// </summary>
