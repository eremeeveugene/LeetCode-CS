...
public abstract class CreateBinaryTreeFromDescriptionsTestsBase<T> where T : ICreateBinaryTreeFromDescriptions, new()
{
    ...
    public void CreateBinaryTree_WithDescriptions_ReturnsBinaryTreeConstructedFromDescriptions(string descriptionsJson,
        string expectedResultJson)
    {
        ...
        var descriptions = JsonHelper<int[][]>.Parse(descriptionsJson);
