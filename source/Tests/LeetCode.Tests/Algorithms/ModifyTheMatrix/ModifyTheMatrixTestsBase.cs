...
public abstract class ModifyTheMatrixTestsBase<T> where T : IModifyTheMatrix, new()
{
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        yield return
        [
            new[] { new[] { 1, 2, -1 }, new[] { 4, -1, 6 }, new[] { 7, 8, 9 } }, new[] { new[] { 1, 2, 9 }, new[] { 4, 8, 6 }, new[] { 7, 8, 9 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 1, -1, 3 }, new[] { -1, 5, -1 }, new[] { 7, -1, 9 } },
            new[] { new[] { 1, 5, 3 }, new[] { 7, 5, 9 }, new[] { 7, 5, 9 } }
        ];

        yield return
        [
            new[] { new[] { 2, 4, 6 }, new[] { 1, 3, 5 }, new[] { 0, 2, 4 } }, new[] { new[] { 2, 4, 6 }, new[] { 1, 3, 5 }, new[] { 0, 2, 4 } }
        ];

        yield return
        [
            new[] { new[] { -1, 1, 2 }, new[] { 3, -1, 4 }, new[] { 5, 6, -1 } },
            new[] { new[] { 5, 1, 2 }, new[] { 3, 6, 4 }, new[] { 5, 6, 4 } }
        ];
        ...
        yield return
        [
            new[] { new[] { -1, -1, -1 }, new[] { 1, 2, 3 }, new[] { 4, 5, 6 } },
            new[] { new[] { 4, 5, 6 }, new[] { 1, 2, 3 }, new[] { 4, 5, 6 } }
        ];

        yield return
        [
            new[] { new[] { 7, 8, 9 }, new[] { -1, -1, -1 }, new[] { 1, 2, 3 } },
            new[] { new[] { 7, 8, 9 }, new[] { 7, 8, 9 }, new[] { 1, 2, 3 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 50, -1, 50 }, new[] { -1, 50, -1 }, new[] { 50, -1, 50 } },
            new[] { new[] { 50, 50, 50 }, new[] { 50, 50, 50 }, new[] { 50, 50, 50 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 1, -1, 1, -1 }, new[] { -1, 2, -1, 2 }, new[] { 3, -1, 3, -1 } },
            new[] { new[] { 1, 2, 1, 2 }, new[] { 3, 2, 3, 2 }, new[] { 3, 2, 3, 2 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 4, 0, -1 }, new[] { -1, 7, 2 }, new[] { 8, -1, 6 } },
            new[] { new[] { 4, 0, 6 }, new[] { 8, 7, 2 }, new[] { 8, 7, 6 } }
        ];
    }
}