...
public abstract class ArithmeticSubarraysTestsBase<T> where T : IArithmeticSubarrays, new()
{
    ...
    [DataRow(new[] { -12, -9, -3, -12, -6, 15, 20, -25, -20, -15, -10 }, new[] { 0, 1, 6, 4, 8, 7 }, new[] { 4, 4, 9, 7, 9, 10 },
    ...
    public void CheckArithmeticSubarrays_WithVariousRanges_VerifiesIfSubarraysAreArithmetic(int[] nums,
        int[] l, int[] r, bool[] expectedResult)
    {
        // Arrange
        var solution = new T();
