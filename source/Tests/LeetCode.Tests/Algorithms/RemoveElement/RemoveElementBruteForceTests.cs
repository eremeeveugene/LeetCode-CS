...
public class RemoveElementBruteForceTests
{
    ...
    public void RemoveElementBruteForce_GetResult_WithArrayAndValue_ReturnsNewLengthAndModifiedArray(int[] actualNums,
        int val, int[] expectedNums, int expectedResult)
    {
        // Act
