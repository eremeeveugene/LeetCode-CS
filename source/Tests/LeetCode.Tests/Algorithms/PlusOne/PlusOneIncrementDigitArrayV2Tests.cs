...
[TestClass]
public class PlusOneIncrementDigitArrayV2Tests
{
    [TestMethod]
    ...
    public void PlusOneIncrementDigitArrayV2_GetResult_WithDigitArray_ReturnsIncrementedArray(int[] digits,
        int[] expectedResult)
    {
        // Act
        var actualResult = PlusOneIncrementDigitArrayV2.GetResult(digits);
