    ...
    where T : IMaximizeHappinessOfSelectedChildren, new()
{
    ...
    [DataRow(
        ...
        41, 2517853814)]
    public void MaximumHappinessSum_WithVariousInputs_ReturnsMaximumHappinessSum(string happinessJson, int k,
        long expectedResult)
    {
        // Arrange
        var happiness = JsonHelper<int>.DeserializeToArray(happinessJson);
