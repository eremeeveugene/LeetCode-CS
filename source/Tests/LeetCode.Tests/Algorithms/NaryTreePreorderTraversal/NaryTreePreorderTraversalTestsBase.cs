...
public abstract class NaryTreePreorderTraversalTestsBase<T> where T : INaryTreePreorderTraversal, new()
{
    ...
    public void PreorderTraversal_WithVariousTreeStructures_ReturnsCorrectPreorderList(string rootArrayJson,
        string expectedResultJsonArray)
    {
        // Arrange
        var solution = new T();

        var expectedResult = JsonHelper<int>.JsonArrayToList(expectedResultJsonArray);
