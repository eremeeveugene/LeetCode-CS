...
public abstract class WalkingRobotSimulationTestsBase<T> where T : IWalkingRobotSimulation, new()
{
    ...
    public void RobotSim_WithMovementCommandsAndObstacles_ReturnsMaxSquaredDistanceFromOrigin(int[] commands,
        int[][] obstacles, int expectedResult)
    {
        // Arrange
        var solution = new T();
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        ...
        [
            ...
            new[]
            {
                new[] { -4, -1 }, new[] { 1, -1 }, new[] { 1, 4 }, new[] { 5, 0 }, new[] { 4, 5 }, new[] { -2, -1 },
                new[] { 2, -5 }, new[] { 5, 1 }, new[] { -3, -1 }, new[] { 5, -3 }
            },
            324
        ];
