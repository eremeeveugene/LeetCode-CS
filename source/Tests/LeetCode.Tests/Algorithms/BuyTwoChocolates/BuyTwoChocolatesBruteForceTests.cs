...
[TestClass]
public class BuyTwoChocolatesBruteForceTests
{
    [TestMethod]
    ...
    public void BuyTwoChocolatesBruteForce_GetResult_WithPriceArrayAndBudget_ReturnsMaxChocolateValue(int[] prices,
        int money, int expectedResult)
    {
        // Act
        var actualResult = BuyTwoChocolatesBruteForce.GetResult(prices, money);
