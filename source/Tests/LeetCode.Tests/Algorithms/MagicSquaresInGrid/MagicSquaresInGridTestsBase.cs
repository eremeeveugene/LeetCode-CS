...
public abstract class MagicSquaresInGridTestsBase<T> where T : IMagicSquaresInGrid, new()
{
    ...
    public void NumMagicSquaresInside_WithGridInput_ReturnsCountOfMagicSquareSubgrids(int[][] grid,
        int expectedResult)
    {
        // Arrange
        var solution = new T();
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        ...
        yield return
        [
            new[] { new[] { 4, 3, 8, 4 }, new[] { 9, 5, 1, 9 }, new[] { 2, 7, 6, 2 }, new[] { 4, 3, 8, 1 }, new[] { 1, 6, 7, 5 } },
            1
        ];
        ...
        [
            new[]
            {
                new[] { 9, 9, 5, 1, 9, 5, 5, 7, 2, 5 }, new[] { 9, 1, 8, 3, 4, 6, 7, 2, 8, 9 },
                new[] { 4, 1, 1, 5, 9, 1, 5, 9, 6, 4 }, new[] { 5, 5, 6, 7, 2, 8, 3, 4, 0, 6 },
                new[] { 1, 9, 1, 8, 3, 1, 4, 2, 9, 4 }, new[] { 2, 8, 6, 4, 2, 7, 3, 2, 7, 6 },
                new[] { 9, 2, 5, 0, 7, 8, 2, 9, 5, 1 }, new[] { 2, 1, 4, 4, 7, 6, 2, 4, 3, 8 },
                new[] { 1, 2, 5, 3, 0, 5, 10, 8, 5, 2 }, new[] { 6, 9, 6, 8, 8, 4, 3, 6, 0, 9 }
            },
            3
        ];
    }
