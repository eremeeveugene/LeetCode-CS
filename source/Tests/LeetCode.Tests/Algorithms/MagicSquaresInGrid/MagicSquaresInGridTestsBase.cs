...
public abstract class MagicSquaresInGridTestsBase<T> where T : IMagicSquaresInGrid, new()
{
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        ...
        yield return [new[] { new[] { 6, 7, 2 }, new[] { 1, 5, 9 }, new[] { 8, 3, 4 } }, 1];

        yield return [new[] { new[] { 8, 1, 6 }, new[] { 3, 5, 7 }, new[] { 4, 9, 2 } }, 1];
        ...
        yield return [new[] { new[] { 9, 4, 3, 8, 0 }, new[] { 5, 9, 5, 1, 0 }, new[] { 1, 2, 7, 6, 0 } }, 1];

        yield return [new[] { new[] { 4, 0, 8 }, new[] { 9, 5, 1 }, new[] { 2, 7, 6 } }, 0];

        yield return [new[] { new[] { 4, 3, 8 }, new[] { 9, 5, 1 }, new[] { 2, -7, 6 } }, 0];
    }
}