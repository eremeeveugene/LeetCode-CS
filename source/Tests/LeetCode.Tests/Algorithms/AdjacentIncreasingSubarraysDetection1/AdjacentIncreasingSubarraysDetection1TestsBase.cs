...
public abstract class AdjacentIncreasingSubarraysDetection1TestsBase<T>
    where T : IAdjacentIncreasingSubarraysDetection1, new()
{
    [TestMethod]
    [DataRow("[2,5,7,8,9,2,3,4,3,1]", 3, true)]
    [DataRow("[1,2,3,4,4,4,4,5,6,7]", 5, false)]
