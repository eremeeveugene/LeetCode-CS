...
public abstract class ValidArrangementOfPairsTestsBase<T> where T : IValidArrangementOfPairs, new()
{
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        ...
        yield return
        [
            new[] { new[] { 10, 20 }, new[] { 20, 30 }, new[] { 30, 40 }, new[] { 40, 50 }, new[] { 50, 60 } },
            new[] { new[] { 10, 20 }, new[] { 20, 30 }, new[] { 30, 40 }, new[] { 40, 50 }, new[] { 50, 60 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 4, 5 }, new[] { 3, 4 }, new[] { 2, 3 }, new[] { 1, 2 } },
            new[] { new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 5 } }
        ];
        ...
        [
            new[]
            {
                new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 5 }, new[] { 5, 6 }, new[] { 6, 7 }, new[] { 7, 8 }, new[] { 8, 9 }
            },
            new[]
            {
                new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 5 }, new[] { 5, 6 }, new[] { 6, 7 }, new[] { 7, 8 }, new[] { 8, 9 }
        ...
        yield return
        [
            new[] { new[] { 100, 200 }, new[] { 200, 300 }, new[] { 300, 400 }, new[] { 400, 500 }, new[] { 500, 600 }, new[] { 600, 700 } },
            new[] { new[] { 100, 200 }, new[] { 200, 300 }, new[] { 300, 400 }, new[] { 400, 500 }, new[] { 500, 600 }, new[] { 600, 700 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 6, 7 }, new[] { 5, 6 }, new[] { 4, 5 }, new[] { 3, 4 }, new[] { 2, 3 }, new[] { 1, 2 } },
        ...
        yield return
        [
            new[] { new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 1 } },
            new[] { new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 1 } }
        ];
        ...
        yield return
        [
            new[] { new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 5 }, new[] { 5, 1 } },
            new[] { new[] { 1, 2 }, new[] { 2, 3 }, new[] { 3, 4 }, new[] { 4, 5 }, new[] { 5, 1 } }
        ];
        ...
        [
            ...
            new[] { new[] { 11, 9 }, new[] { 9, 4 }, new[] { 4, 5 }, new[] { 5, 1 } }
        ];
