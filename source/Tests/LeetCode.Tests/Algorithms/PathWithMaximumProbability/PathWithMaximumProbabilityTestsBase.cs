...
public abstract class PathWithMaximumProbabilityTestsBase<T> where T : IPathWithMaximumProbability, new()
{
    [TestMethod]
    [DataRow(2, "[]", "[]", 0, 1, 0)]
    [DataRow(3, "[[0,1]]", "[0.5]", 0, 2, 0)]
    [DataRow(3, "[[0,1],[1,2],[0,2]]", "[0.5,0.5,0.2]", 0, 2, 0.25)]
    [DataRow(3, "[[0,1],[1,2],[0,2]]", "[0.5,0.5,0.3]", 0, 2, 0.3)]
    [DataRow(4, "[[0,1],[1,2],[2,3],[0,3]]", "[0.4,0.3,0.2,0.1]", 0, 3, 0.1)]
    [DataRow(5, "[[1,4],[2,4],[0,4],[0,3],[0,2],[2,3]]", "[0.37,0.17,0.93,0.23,0.39,0.04]", 3, 4, 0.2139)]
