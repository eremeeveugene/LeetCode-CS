...
public abstract class PathWithMaximumProbabilityTestsBase<T> where T : IPathWithMaximumProbability, new()
{
    ...
    public void MaxProbability_GivenGraphAndProbabilities_ReturnsMaxProbability(int n, int[][] edges,
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        ...
        yield return
        [
            10, new[] { new[] { 0, 1 }, new[] { 0, 2 }, new[] { 1, 3 }, new[] { 2, 4 }, new[] { 3, 5 }, new[] { 4, 5 }, new[] { 5, 6 }, new[] { 5, 7 }, new[] { 6, 8 }, new[] { 7, 9 } },
            new[] { 0.1, 0.2, 0.5, 0.6, 0.3, 0.7, 0.8, 0.9, 0.4, 0.5 }, 0, 9, 0.03780
        ];

        yield return
        [
            15, new[] { new[] { 0, 1 }, new[] { 0, 2 }, new[] { 1, 3 }, new[] { 2, 4 }, new[] { 3, 5 }, new[] { 4, 5 }, new[] { 5, 6 }, new[] { 6, 7 }, new[] { 7, 8 }, new[] { 8, 9 }, new[] { 9, 10 }, new[] { 10, 11 }, new[] { 11, 12 }, new[] { 12, 13 }, new[] { 13, 14 } },
