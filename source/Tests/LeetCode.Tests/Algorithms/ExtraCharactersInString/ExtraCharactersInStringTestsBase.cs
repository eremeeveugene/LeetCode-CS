...
public abstract class ExtraCharactersInStringTestsBase<T> where T : IExtraCharactersInString, new()
{
    ...
    [DataRow("dwmodizxvvbosxxw",
        new[] { "ox", "lb", "diz", "gu", "v", "ksv", "o", "nuq", "r", "txhe", "e", "wmo", "cehy", "tskz", "ds", "kzbu" },
        7)]
    [DataRow("azvzulhlwxwobowijiyebeaskecvtjqwkmaqnvnaomaqnvf",
        new[] { "na", "i", "edd", "wobow", "kecv", "b", "n", "or", "jj", "zul", "vk", "yeb", "qnfac", "azv", "grtjba", "yswmjn", "xowio", "u", "xi", "pcmatm", "maqnv" },
        15)]
    public void MinExtraChar_WithStringAndDictionary_ReturnsMinExtraChars(string s, string[] dictionary,
        int expectedResult)
    {
        // Arrange
        var solution = new T();
