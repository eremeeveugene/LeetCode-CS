    ...
    where T : IMaximizeTheNumberOfTargetNodesAfterConnectingTrees1, new()
{
    ...
    public void MaxTargetNodes_WithTwoTreesAndDistanceLimit_ReturnsMaxTargetsPerNode(int[][] edges1,
        int[][] edges2, int k, int[] expectedResult)
    {
        // Arrange
        var solution = new T();
    ...
    private static IEnumerable<object[]> GetTestData()
    {
        yield return
        [
            new[] { new[] { 0, 1 }, new[] { 0, 2 }, new[] { 2, 3 }, new[] { 2, 4 } },
            new[] { new[] { 0, 1 }, new[] { 0, 2 }, new[] { 0, 3 }, new[] { 2, 7 }, new[] { 1, 4 }, new[] { 4, 5 }, new[] { 4, 6 } },
            2, new[] { 9, 7, 9, 8, 8 }
        ];

        yield return
        [
            new[] { new[] { 0, 1 }, new[] { 0, 2 }, new[] { 0, 3 }, new[] { 0, 4 } },
            new[] { new[] { 0, 1 }, new[] { 1, 2 }, new[] { 2, 3 } }, 1, new[] { 6, 3, 3, 3, 3 }
        ];
    }
}