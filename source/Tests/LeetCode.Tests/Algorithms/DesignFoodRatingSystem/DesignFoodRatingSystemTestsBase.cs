...
public abstract class DesignFoodRatingSystemTestsBase
{
    ...
    private static IEnumerable<FoodRatingSystemScenario[]> GetScenarios()
    {
        ...
        // Single food item
        yield return [new FoodRatingSystemScenario(["burger"], ["american"], [10], [new HighestRatedOperation("american")], [new HighestRatedOperation.Result("burger")])];

        // Change rating then check
        yield return [new FoodRatingSystemScenario(["x", "y"], ["c1", "c1"], [5, 10], [new HighestRatedOperation("c1"), new ChangeRatingOperation("y", 1), new HighestRatedOperation("c1")], [new HighestRatedOperation.Result("y"), VoidOperationResult.Instance, new HighestRatedOperation.Result("x")])];

        // Three foods same cuisine, all same rating - lexicographic winner
        yield return [new FoodRatingSystemScenario(["cherry", "apple", "banana"], ["fruit", "fruit", "fruit"], [5, 5, 5], [new HighestRatedOperation("fruit")], [new HighestRatedOperation.Result("apple")])];

        // Multiple changes to same food
        yield return [new FoodRatingSystemScenario(["noodle"], ["asian"], [3], [new ChangeRatingOperation("noodle", 100), new HighestRatedOperation("asian")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("noodle")])];

        // Two foods, one cuisine, multiple changes
        yield return [new FoodRatingSystemScenario(["pad thai", "pho"], ["asian", "asian"], [8, 6], [new HighestRatedOperation("asian"), new ChangeRatingOperation("pho", 20), new HighestRatedOperation("asian"), new ChangeRatingOperation("pad thai", 25), new HighestRatedOperation("asian")], [new HighestRatedOperation.Result("pad thai"), VoidOperationResult.Instance, new HighestRatedOperation.Result("pho"), VoidOperationResult.Instance, new HighestRatedOperation.Result("pad thai")])];

        // Foods with same rating after change - lexicographic order
        yield return [new FoodRatingSystemScenario(["zebra roll", "avocado toast"], ["fusion", "fusion"], [10, 8], [new ChangeRatingOperation("avocado toast", 10), new HighestRatedOperation("fusion")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("avocado toast")])];

        // Different cuisines no interference
        yield return [new FoodRatingSystemScenario(["croissant", "baguette", "ramen"], ["french", "french", "japanese"], [9, 7, 15], [new HighestRatedOperation("french"), new HighestRatedOperation("japanese"), new ChangeRatingOperation("baguette", 20), new HighestRatedOperation("french")], [new HighestRatedOperation.Result("croissant"), new HighestRatedOperation.Result("ramen"), VoidOperationResult.Instance, new HighestRatedOperation.Result("baguette")])];

        // Rating goes down to zero - still highest in cuisine
        yield return [new FoodRatingSystemScenario(["a", "b"], ["cat", "cat"], [100, 50], [new ChangeRatingOperation("a", 1), new HighestRatedOperation("cat")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("b")])];

        // Multiple foods single cuisine check order stability
        yield return [new FoodRatingSystemScenario(["m", "n", "o", "p"], ["q", "q", "q", "q"], [1, 2, 3, 4], [new HighestRatedOperation("q"), new ChangeRatingOperation("p", 0), new HighestRatedOperation("q")], [new HighestRatedOperation.Result("p"), VoidOperationResult.Instance, new HighestRatedOperation.Result("o")])];

        // Decrease highest-rated food rating below second highest
        yield return [new FoodRatingSystemScenario(["taco", "burrito"], ["mex", "mex"], [10, 5], [new ChangeRatingOperation("taco", 3), new HighestRatedOperation("mex")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("burrito")])];

        // Many changes across cuisines
        yield return [new FoodRatingSystemScenario(["steak", "salad", "soup"], ["american", "salad_bar", "soup_kitchen"], [7, 6, 5], [new ChangeRatingOperation("steak", 1), new ChangeRatingOperation("salad", 1), new ChangeRatingOperation("soup", 1), new HighestRatedOperation("american"), new HighestRatedOperation("salad_bar"), new HighestRatedOperation("soup_kitchen")], [VoidOperationResult.Instance, VoidOperationResult.Instance, VoidOperationResult.Instance, new HighestRatedOperation.Result("steak"), new HighestRatedOperation.Result("salad"), new HighestRatedOperation.Result("soup")])];

        // Same food rated multiple times
        yield return [new FoodRatingSystemScenario(["pizza", "pasta"], ["italian", "italian"], [10, 8], [new ChangeRatingOperation("pizza", 5), new HighestRatedOperation("italian"), new ChangeRatingOperation("pizza", 15), new HighestRatedOperation("italian")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("pasta"), VoidOperationResult.Instance, new HighestRatedOperation.Result("pizza")])];

        // All foods in one cuisine, select highest changes frequently
        yield return [new FoodRatingSystemScenario(["aa", "bb", "cc", "dd"], ["x", "x", "x", "x"], [4, 3, 2, 1], [new HighestRatedOperation("x"), new ChangeRatingOperation("dd", 10), new HighestRatedOperation("x"), new ChangeRatingOperation("aa", 0), new HighestRatedOperation("x")], [new HighestRatedOperation.Result("aa"), VoidOperationResult.Instance, new HighestRatedOperation.Result("dd"), VoidOperationResult.Instance, new HighestRatedOperation.Result("dd")])];

        // Tie breaking with identical names after rating changes
        yield return [new FoodRatingSystemScenario(["alpha", "beta", "gamma"], ["greek", "greek", "greek"], [10, 9, 8], [new ChangeRatingOperation("beta", 10), new HighestRatedOperation("greek"), new ChangeRatingOperation("gamma", 10), new HighestRatedOperation("greek")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("alpha"), VoidOperationResult.Instance, new HighestRatedOperation.Result("alpha")])];

        // Sequential changes lead to single winner
        yield return [new FoodRatingSystemScenario(["spring roll", "dim sum"], ["chinese", "chinese"], [5, 5], [new ChangeRatingOperation("dim sum", 6), new HighestRatedOperation("chinese"), new ChangeRatingOperation("spring roll", 7), new HighestRatedOperation("chinese")], [VoidOperationResult.Instance, new HighestRatedOperation.Result("dim sum"), VoidOperationResult.Instance, new HighestRatedOperation.Result("spring roll")])];
    }
