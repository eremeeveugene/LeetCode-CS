...
public abstract class MyCalendar1TestsBase<T> where T : IMyCalendar1, new()
{
    ...
    [DataRow(new[] { 0, 1000000000 }, new[] { 1000000000, 1000000000 }, new[] { true, false })]
    [DataRow(new[] { 5, 10, 15 }, new[] { 8, 12, 18 }, new[] { true, false, true })]
    [DataRow(new[] { 1, 2, 3 }, new[] { 2, 3, 4 }, new[] { true, true, true })]
    [DataRow(new[] { 11, 15, 9 }, new[] { 13, 20, 14 }, new[] { true, true, true })]
