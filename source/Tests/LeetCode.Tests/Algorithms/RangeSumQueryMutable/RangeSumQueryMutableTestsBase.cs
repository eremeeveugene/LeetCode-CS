...
public abstract class RangeSumQueryMutableTestsBase
{
    ...
    public sealed class RangeSumQueryMutableScenario : Scenario<IRangeSumQueryMutable>
    {
        public RangeSumQueryMutableScenario(int[] nums, IOperation<IRangeSumQueryMutable>[] operations,
