    ...
    where T : IMaximumNumberOfTasksYouCanAssign, new()
{
    ...
    public void MaxTaskAssign_WithGivenTasksWorkersPillsAndStrength_ReturnsMaxAssignableTasks(int[] tasks,
        int[] workers, int pills, int strength, int expectedResult)
    {
        // Arrange
        var solution = new T();
