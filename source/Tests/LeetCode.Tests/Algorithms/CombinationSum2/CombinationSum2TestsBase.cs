...
{
    [TestMethod]
    [DataRow(new[] { 10, 1, 2, 7, 6, 1, 5 }, 8, "[[1,1,6],[1,2,5],[1,7],[2,6]]")]
    [DataRow(new[] { 2, 5, 2, 1, 2 }, 5, "[[1,2,2],[5]]")]
    public void CombinationSum2_WithCandidatesAndTarget_ReturnsExpectedCombinations(int[] candidates, int target,
