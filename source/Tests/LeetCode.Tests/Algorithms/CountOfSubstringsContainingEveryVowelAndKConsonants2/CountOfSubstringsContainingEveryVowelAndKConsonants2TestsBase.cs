...
public abstract class CountOfSubstringsContainingEveryVowelAndKConsonants2TestsBase<T> where T :
    ICountOfSubstringsContainingEveryVowelAndKConsonants2, new()
{
    [TestMethod]
    [DataRow("aeioqq", 1, 0)]
    [DataRow("aeiou", 0, 1)]
