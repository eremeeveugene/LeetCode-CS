...
{
    [TestMethod]
    [DataRow(new[] { "1313579440F2036", "2921522980M5644" }, 0)]
    [DataRow(new[] { "7868190130M7522", "5303914400F9211", "9273338290F4010" }, 2)]
    [DataRow(new[] { "4444444444F6030", "5555555555M7041", "6666666666O4055", "7777777777F6021" }, 1)]
    ...
    [DataRow(
        new[]
        {
            "1137774788O7691", "7472708234O0072", "9885137889M8868", "1321925389M8161", "5574709492O7158",
            "2205791488F8896", "1537217483M5762"
        }, 5)]
    public void CountSeniors_WithDetailsArray_ReturnsCorrectSeniorCount(string[] details, int expectedResult)
    {
        // Arrange
        var solution = new T();
