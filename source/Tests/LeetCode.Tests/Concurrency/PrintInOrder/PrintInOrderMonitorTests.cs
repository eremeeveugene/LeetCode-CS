...
[TestClass]
public class PrintInOrderMonitorTests : PrintInOrderTestsBase
{
    [TestMethod]
    [DataRow(new[] { 1, 2, 3 })]
    [DataRow(new[] { 2, 3, 1 })]
    [DataRow(new[] { 3, 1, 2 })]
    public async Task PrintInOrderMonitor_ExecuteThreads_WithSpecificOrder_ReturnsOrderedOutput(int[] nums)
    {
        // Arrange
