...
public class MergeTwoSortedListsTests
{
    ...
    public void MergeTwoSortedLists_GetResult_ShouldMergeAndMatchExpectedResult(int[] array1, int[] array2, int[] expectedResultArray)
    {
        // Arrange
        var list1 = array1.Reverse().Aggregate<int, ListNode?>(null, (current, t) => new ListNode(t, current));
        var list2 = array2.Reverse().Aggregate<int, ListNode?>(null, (current, t) => new ListNode(t, current));
        var expectedResultList = expectedResultArray.Reverse()
            .Aggregate<int, ListNode?>(null, (current, t) => new ListNode(t, current));
